...
if __name__ == '__main__':
    ...
    temp = open("C:\Users\Daniel\Desktop\PRICE.csv",'r')
    full = csv.reader(temp)
    symbol = []
    temp1 = open("C:\Users\Daniel\Desktop\FIN.csv",'w')
    ...
    for s in full:
        try:
            ...
            counter += 1
            event = deque()
            data = datahandler.SGXHandler(event,s[0],start,end)
            portfolio = Portfolio.Portfolio(event,s[0])
        
            a = Backtest(event,data,portfolio,s[0])
